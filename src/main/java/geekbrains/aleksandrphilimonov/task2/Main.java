...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(array1.getClass().getSimpleName() + " -> " + list1.getClass().getSimpleName());

        ArrayList<Integer> list2 = convertArrayToArrayList(array2);
        System.out.println(array2.getClass().getSimpleName() + " -> " + list2.getClass().getSimpleName());

        ArrayList<Float> list3 = convertArrayToArrayList(array3);
        System.out.println(array3.getClass().getSimpleName() + " -> " + list3.getClass().getSimpleName());
    }
